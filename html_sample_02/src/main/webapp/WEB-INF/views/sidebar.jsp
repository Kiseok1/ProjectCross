...
$(function(){
 ...
 <div id="view-box" style="display: flex; justify-content: center; border-left: 1px solid var(--twitter-background-color);" >
	 ...
	 <nav style="margin-top: 20px;" >
		...
		<a href="/profile/content" class="sidebar_a">
        ...
        <a href="/bookmark/bookmark" class="sidebar_a">
        <div class="Menu_options">
        ...
        <a href="/message/index" class="sidebar_a">
        <div class="Menu_options">
        ...
        <a href="/alram/alram" class="sidebar_a">
        <div class="Menu_options">
		 ...
		 <a href="/search/search_in" class="sidebar_a">
		 <div class="Menu_options">
		...
		<div><br></div>
	 	...
	 	<a href="/login/login" class="sidebar_a">
	 	<div class="Menu_options">
